...
function Display:set_parameter(param,ui_obj,point,skip_ui)
  ...
  if not skip_ui then
    ...
    if widget then
      ...
      local handle_single_text_widget = function()
        widget.font = "mono"
        widget.align = "center"
        widget.text = tostring(value)
      end
      ...
      local widget_types = {
        ...
        ["Text"] = function() handle_single_text_widget() end,
      ...
      if not (msg_type == DEVICE_MESSAGE.OSC) then
        ...
        local msg_types = {
          ...
          [DEVICE_MESSAGE.MIDI_CC] = function() 
            ...
            self.device:send_cc_message(num,math.floor(value),channel,send_multibyte,param)
          end,
